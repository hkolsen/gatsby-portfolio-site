...
resourcesHeroImgURL: https://noti.st/heidiolsen/qrHED6/effective-storytelling-with-data-visualization
resourceList:
  - id: 1
    category: Read
    content: >-
...
codeSamplesList:
  - id: 1
    ...
    img: ../img/codepen/simple-numbers.png
    linkURL: https://codepen.io/SwissWebMiss/pen/QWLeJVL
  - id: 2
    title: >-
      Comparison Chart: Two Products
    img: ../img/codepen/two-products.png
    linkURL: https://codepen.io/SwissWebMiss/pen/bGGNRjM
  - id: 3
    title: >-
      Comparison Chart: Multiple Products
    img: ../img/codepen/multiple-products.png
    linkURL: https://codepen.io/SwissWebMiss/pen/YzKmbWX
  - id: 4
    title: Progress Bar
    img: ../img/codepen/progress-bar.png
    linkURL: https://codepen.io/SwissWebMiss/pen/LYYELqR
  - id: 5
    title: Area Chart
    img: ../img/codepen/area-chart.png
    linkURL: https://codepen.io/SwissWebMiss/pen/rNNazJM
---